...
for row in eachrow(df) 
    ...
    lambda_reg = 0.01
    final_transport_matrix, log_dict = sinkhorn_log(p, q, normalized_cost_matrix, lambda_reg; tol=1e-4, verbose=true, logging=true, enforce_marginals=true)
    ...
    transport_matrix_filename = joinpath("/Users/justinmeng/Desktop/Project OR2/experiments/result/sklog0.01_dataset2_res", "transport_matrix_instance$(instance_number)_$(m)x$(n).csv")
...
log_filename = joinpath("/Users/justinmeng/Desktop/Project OR2/experiments/result/sklog0.01_dataset2_res", "sklog0.01_dataset2_log.csv") 
